...
- **The doctoral research stays off a generated CV.** It is recorded above and in its own role file, but it does not appear on the page - not as a qualification, not as a bullet under the MEng, and not as a clause on the MEng's date line. A reader who wants it will ask.
